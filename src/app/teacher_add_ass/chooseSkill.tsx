...
export default function ChooseSkillDropdown() {
  return (
    <Menu as="div" className="relative inline-block text-left w-full mt-2">
      ...
      >
        <Menu.Items className="absolute right-1/2 transform translate-x-1/2 z-10 mt-2 w-[300 px] origin-top-center rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <a
